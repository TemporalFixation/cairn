...
export default function UsersPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto py-8 px-4 space-y-6">
      ...
      {/* CSV info */}
      <div className="rounded-md border border-border bg-muted/30 px-4 py-3 text-xs text-muted-foreground space-y-0.5">
        <p className="font-semibold text-foreground text-sm">CSV Format</p>
        <p>Required columns: <span className="font-mono">FirstName, LastName</span></p>
        <p>Optional: <span className="font-mono">EmailAddress, IdNumber, UserType (Staff/Student), Role (User/SuperUser/Admin)</span></p>
